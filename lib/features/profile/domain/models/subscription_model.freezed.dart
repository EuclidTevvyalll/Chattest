...
mixin _$SubscriptionModel {
 ...
 String get id;@JsonKey(name: 'user_id') String get userId; double get amount;@JsonKey(name: 'duration_months') int get durationMonths;@JsonKey(name: 'created_at') DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,amount,durationMonths,createdAt);

@override
String toString() {
  return 'SubscriptionModel(id: $id, userId: $userId, amount: $amount, durationMonths: $durationMonths, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId, double amount,@JsonKey(name: 'duration_months') int durationMonths,@JsonKey(name: 'created_at') DateTime createdAt
});
...
/// Create a copy of SubscriptionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? amount = null,Object? durationMonths = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  double amount, @JsonKey(name: 'duration_months')  int durationMonths, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SubscriptionModel() when $default != null:
return $default(_that.id,_that.userId,_that.amount,_that.durationMonths,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  double amount, @JsonKey(name: 'duration_months')  int durationMonths, @JsonKey(name: 'created_at')  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _SubscriptionModel():
return $default(_that.id,_that.userId,_that.amount,_that.durationMonths,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'user_id')  String userId,  double amount, @JsonKey(name: 'duration_months')  int durationMonths, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _SubscriptionModel() when $default != null:
return $default(_that.id,_that.userId,_that.amount,_that.durationMonths,_that.createdAt);case _:
  return null;
...
class _SubscriptionModel implements SubscriptionModel {
  const _SubscriptionModel({required this.id, @JsonKey(name: 'user_id') required this.userId, required this.amount, @JsonKey(name: 'duration_months') required this.durationMonths, @JsonKey(name: 'created_at') required this.createdAt});
...
/// Create a copy of SubscriptionModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? amount = null,Object? durationMonths = null,Object? createdAt = null,}) {
